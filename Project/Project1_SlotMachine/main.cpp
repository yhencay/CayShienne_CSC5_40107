                ...
                do {            
                    if (budget > 0) {
                        do {
                            ...
                            if ((choice == 'S' || choice == 's') && budget>0) {                  
                                do {                        
                                    cout<<endl<<"BET: $";
                                    cin>>bet;

                                    if (bet>budget) cout<<"Your bet cannot be higher than your capital!\n"<<endl;
                                    else if (bet<=0) cout<<"Bet must be greater than 0!\n"<<endl;
                                ...
                                } while (bet<=0 && budget>0); //(bet>budget ||                                 
                            }
                        ...
                        } while ((choice == 'S' || choice == 's') && x && budget>0); 
                    }
