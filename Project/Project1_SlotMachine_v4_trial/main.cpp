        ...
        switch (begin) {                                            //Case statement for choice in variable Begin
            ...
            case 'Y': {
                ...
                do {                                                //Start loop for budget condition. If bool x for budget is true, continue loop.
                            ...
                            if ((choice == 'S' || choice == 's') && budget>minVal) {       //If user chose to spin and budget is greater than 0   
                                do {                        
                                    ...
                                    if (bet>budget) {                   //If bet is greater than the budget, display invalidity
                                        cout<<"\nYour bet cannot be higher than your capital!\n"<<endl;
                                        cout<<"\nYour remaining cash is $"<<budget<<endl<<endl;
                                    }
                                    else if (bet<=minVal) {             //If bet is equal to 0, display invalidity
                                        cout<<"\nBet must be greater than 0!\n"<<endl;
                                        cout<<"\nYour remaining cash is $"<<budget<<endl<<endl;
                                    }                              
                                    else if (bet<=budget && bet>minVal) {     //If bet is less than budget and budget is greater than 0
                                ...
                                } while (budget>minVal && bet<minVal && budget!=minVal);                //Loop for spin or cancel if budget>0, bet is less than 0 and budget                                 
                            }                                                                           //budget is > 0.
                    ...
                    else x=false;                       //If no conditions are exit game play loop
